                    ...
                    if interface.tag == 'EventInputs':
                        ...
                        for event in interface:
                            try:
                                ...
                                self.input_events[event_name] = (event_type, 0, False)
                    ...
                    # Output Events
                        ...
                        for event in interface:
                            try:
                                ...
                                self.output_events[event_name] = (event_type, 0, False)
                    ...
                    # Input vars
                        ...
                        for var in interface:
                            try:
                                ...
                                self.input_vars[var_name] = (var_type, var_value, False)
                    ...
                    # Output vars
                        ...
                        for var in interface:
                            try:
                                ...
                                self.output_vars[var_name] = (var_type, var_value, False)
