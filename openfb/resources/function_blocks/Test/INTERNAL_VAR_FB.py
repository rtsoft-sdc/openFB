...
class INTERNAL_VAR_FB:
    def schedule(self, event_name, event_value, BOOL_IN, BYTE_IN, DINT_IN, DWORD_IN, INT_IN,
       ...
       logging.info(f"bool_in={BOOL_IN}, byte_in={BYTE_IN}, dint_in={DINT_IN}, dword_in={DWORD_IN}, "
                 f"int_in={INT_IN}, lreal_in={LREAL_IN}, real_in={REAL_IN}, sint_in={SINT_IN}, "
                 f"string_in={STRING_IN}, time_in={TIME_IN}, udint_in={UDINT_IN}, uint_in={UINT_IN}, "
                 f"usint_in={USINT_IN}, word_in={WORD_IN}, wstring_in={WSTRING_IN}")
